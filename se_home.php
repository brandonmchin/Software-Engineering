			...
			<ul>
				...
				<li><a href="#" id="user"><?php echo $user; ?></a>
					<ul>
						...
						<!--<li><a href="php/bookseller/rate_books.php">Rate Books</a></li>-->
						<li><a href="php/bookseller/rate_seller.php">Rate/Complain_Sellers</a></li>
						<li><a href="php/bookseller/account.php">Add_balance</a></li><!-- -->
						<!--<li><a href="php/bookseller/complain_seller.php">File_Seller_Complaint</a></li>-->
						...
						<li><a href="php/bookseller/bid.php">Bid_on_Book</a></li> <!--done 100% -->
						<li><a href="php/bookseller/buy.php">Buy_Book</a></li> <!--done 100% -->
						<li><a href="php/bookseller/sell.php">Sell_Book</a></li> <!--done -->
					</ul>
				</li>

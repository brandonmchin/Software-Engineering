...
<html lang="en-US" xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	...
	<body>
		...
		<div id="header" class="shell">
			...
			<center><h3>Rate Sellers</h3></center>
			<!-- End Header -->
			<br><br><br>
			<h3>
			<form>
				<fieldset >
					...
					<?php
						$sql = "SELECT * FROM users WHERE Type = 'SE' AND UserName <> '$user'";
						$query = mysql_query($sql);
						//var comm = null;
						// if no results were found
						$num_rows = mysql_num_rows($query);
				    	if($num_rows == 0)
				    	    echo "<font color=red>There are currently no sellers in the database.</font>";
						...
						while($row = mysql_fetch_array($query))
						{
							...
							echo "<td align='center'>
								<button><a href='rate_user_update.php?rateduser=$rateduser&decision=rate'>Rate</a></button>

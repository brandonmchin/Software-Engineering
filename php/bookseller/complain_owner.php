		...
		<div id="header" class="shell">
			...
			<form>
				<fieldset >
					...
					<?php
						$sql = "SELECT * FROM booksownedby WHERE UserName <> '$user' AND UserName NOT IN(SELECT UserName FROM users WHERE Activated = '0') AND UserName NOT IN(SELECT UserName FROM users WHERE Type = 'SE')";

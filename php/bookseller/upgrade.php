...
<html lang="en-US" xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	...
	<body>
		...
		<div id="header" class="shell">
			...
			<center><h3>Request Upgrade</h3></center>
			<!-- End Header -->
			<br><br><br>
			<h3>
			<form>
				<fieldset >
					<legend>to Book Seller</legend><br>
					...
					<?php
						...
						echo "<tr><th>Index</th><th>Options</th></tr>";
						while($row = mysql_fetch_array($query))
						{
							...
							echo "<td align='center'>
									...
									<button><a href='request_up.php?decision=up'>Upgrade_to_Book_Seller</a></button>

...
<html lang="en-US" xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	...
	<body>
		...
		<div id="header" class="shell">
			...
			<form>
				<fieldset >
					<legend>Books Being Sold, Bids go up by $1</legend><br>
					...
					<?php
						...
						while($row = mysql_fetch_array($query))
						{
							...
							echo "<td align='center'>
									...
									<button><a href='place_bid.php?title=$title&author=$author&seller=$seller&bid=$bid&decision=pbid'>Place_Bid</a></button>

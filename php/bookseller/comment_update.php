<?php
	...
	if($decision == 'comment')
	{
	$new_comm = "INSERT INTO comments VALUES ('$title', '$author', '$newcomm')";
...
<html lang="en-US" xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	...
	<body>
		...
		<div id="header" class="shell">
			...
			<br><br><br>
			<h3>
			<form id='comment' action='comment_update.php' method='post' accept-charset='UTF-8' enctype = "multipart/form-data">
				<fieldset >
					<legend>New Comment</legend><br>
					<input type='hidden' name='submitted' id='submitted' value='1'/>

					<label for='newcomm' >Newcomm:</label>
					<input type='text' name='newcomm' id='newcomm' maxlength="100"/><br>
